  ...
  <>
    <section id="book-list" className="wrapper fullscreen">
      <div className="inner">
        ...
        <dl>
          <dt>
            Richtig gut rüberkommen: Wie Sie empathisch und erfolgreich
            kommunizieren
          </dt>
          <dd>
            A German book about the art of good communication. Mirroring the
            other person and by that creating a symmetry to archive a higher
            goal is teached in the book.
          </dd>
